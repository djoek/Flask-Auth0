...
from flask_auth0 import __version__
...
class AuthorizationCodeFlow(object):
    ...
    def __init__(self, app=None,
        ...
        self.app = app
        self.user_agent = f"flask-auth0/{__version__} python-requests/{requests.__version__}"
    ...
    def init_app(self, app):
        ...
        blueprint.before_app_request(self._initialize_request_auth_variables)

        app.register_blueprint(blueprint=blueprint, url_prefix=self.url_prefix)

    @staticmethod
    def _initialize_request_auth_variables():
        # dict that stores the tokens etc for the duration of the request
        ...
        def actual_decorator(func):
            ...
            def decorated_function(*args, **kwargs):
                ...
                if enforce:
                    ...
                    raise Unauthorized(description="You are not authenticated")
                return func(*args, **kwargs)
    ...
    def is_authenticated(self):
        ...
        return g.flask_auth0_tokens.get('access_token') is not None
